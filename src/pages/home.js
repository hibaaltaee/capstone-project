    ...
    <>
      <div className="containerr">
        <div className="section">
          ...
          <p>
            {" "}
            We are a family owned Mediterranean restaurant,<br></br>
      ...
      <div className="hero1">
        ...
        <div className="cards">
          <div className="card1">
            ...
            <p>8.99 $</p>
            <p>
              The famous greek salad of crispy <br></br>
          ...
          <div className="card1">
            ...
            <p>10.99 $</p>
            <p>
              Our Bruschetta is made from grilled <br></br>
              bread that has been smeared with <br></br>garlic and seasoned with
              salt and <br></br>olive oil.
            </p>
            <button>Order for delivery</button>
          </div>
          <div className="card1">
            ...
            <p>12.99 $</p>
            <p>
              This comes straight from grandma's <br></br>recipe book, every
              last ingredient <br></br> has been sourced and is as <br></br>{" "}
